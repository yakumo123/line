...
function BanCardReply(count) {
	let returnStr = '';
	if (count == 0) returnStr = '生命量產-金';
	if (count == 1) returnStr = '虛數物體-金';
	if (count == 2) returnStr = '帕拉塞爾蘇斯-金';
	if (count == 3) returnStr = '境界線的惡魔-金';
if (count == 4) returnStr = '天威劍士-金';
	...
	if (count == 9) returnStr = '銀輪的迴旋者-金';
	if (count == 10) returnStr = '心神統治者‧莫頓-金';
	if (count == 11) returnStr = '哈克菈比-金';
	if (count == 12) returnStr = '異界傳送-金';
	if (count == 13) returnStr = '無心之鬥-金';
