...
if (count == 11) returnStr = '梅林-虹';
if (count == 12) returnStr = '大召喚師‧伊拉斯莫斯-虹';
if (count == 13) returnStr = '秘銀巨像-虹';
if (count == 14) returnStr = '魔導巨兵-虹';
if (count == 15) returnStr = '言靈使者‧洋荷-虹';
if (count == 16) returnStr = '次元魔女‧桃樂絲-虹';
if (count == 17) returnStr = '太陽巫女‧帕梅拉-虹';
