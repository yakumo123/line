...
let RPGCareerArr = ['戰士（FIG） \n【特徵】：可以裝備強大的武器和重甲。不僅作為一個簡單的戰鬥人員，也是作為一個站在前衛的防衛。但移動速度偏低。', '騎士（KNI） \n【特徵】：可以裝備非常重的盔甲。此外，亦擁有優秀的防守技能。但戰鬥力不高。', '狂戰士（BER） \n【特徵】：可以裝備一件非常重的武器。而且可以使用瞬發火力高的攻擊技能。但是，大多數裝甲不能裝備，並且耐力很低。', '盜賊（THI） \n【特徵】：移動速度快。可以使用特殊技能“隱藏”。隱藏時，敵人無法察覺存在的氣息，並且能在“隱藏”時發動技能“突襲”。而且具有“陷阱解除”，“偷竊”等技巧。但只能穿輕便且防禦力很低的皮裝或布裝，防禦力低且被攻擊時傷害會翻倍。', '祭司（SHE） \n【特徵】：優秀的輔助。除了擁有很多輔助系統的魔法，召喚魔法，並持有大量治療及狀態異常回復的魔法。但是只能裝備極輕的裝甲，不過能裝備持有神聖屬性附魔的裝甲。', '魔法師（MAG） \n【特徵】：能使用大量的元素魔法及擁有大範圍的攻擊魔法，此外亦能使用附魔魔法對武器進化附魔，替武器附上不同的屬性。魔力回復速度極高且魔法做成的傷害極大。不過只能裝備防禦力低下的輕便裝甲。', '死靈法師（NEC） \n【特徵】：能使用大量的召喚魔法。此外亦擁有“死者復甦”跟“靈魂附着。但使役亡者需要消耗大量魔力，耐久值偏低'];
...
let rplyArr = ['吉 吉 大 爆 炸','我…我才不告訴你呢……!哼!','我才不要說呢!','如果我不說 我會怎樣','你的樣子如何 你的命運也必如何','為何…為何你要問我……','我不會告訴你的','明明人家都不知道','要爆炸啦~','麻糬','吉爆','爆吉','大爆吉','大吉吉','你大吉吉','這我一定吉','你真的凶爆呃','請選擇：凶爆 爆凶','吉到爆啦','別吉啦','超吉','超級上吉','大吉','吉','中吉','小吉','末吉','中吉','凶','小凶','沒凶','大凶','很凶','你不要知道比較好呢','命運在手中,何必問我','凶爆','你好凶','凶屁凶','乖 你不會想知道的','嗯…殘念','有吉也沒用 唉…','你猜猜看','嗯咦 嗯… 嗯','這是世界的真理','你不能看透這世界','我勸你 不要追問下去'];
