...
if (count == 11) returnStr = '凱爾貝洛斯-虹';
if (count == 12) returnStr = '普魯托-虹';
if (count == 13) returnStr = '骨骸王-虹';
if (count == 14) returnStr = '靈魂守門人‧命忒-虹';
if (count == 15) returnStr = '魔將‧赫克托-虹';
if (count == 16) returnStr = '奈芙蒂斯-虹';
if (count == 17) returnStr = '蒼蠅王-虹';
