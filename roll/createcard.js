...
function build7char(text01){
	...
	ReStr = ReStr + '\n【攻擊力】：' ;
	if (level < 2 && level > 0) ReStr = ReStr + ATOne + '【血量】：' + HEOne + '\n' ;
	if (level < 2 && level > 0 abilty < 2 && abilty > 0) ReStr = ReStr + BasicEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (level < 2 && level > 0 abilty < 3 && abilty > 1) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (level < 2 && level > 0 abilty < 4 && abilty > 2) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + BasicEffect;
	if (level < 2 && level > 0 abilty < 5 && abilty > 3) ReStr = ReStr + BasicEffect + '\n' + '回合結束時' + EndEffect ;
	if (level < 2 && level > 0 abilty < 6 && abilty > 4) ReStr = ReStr + BasicEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (level < 2 && level > 0 abilty < 7 && abilty > 5) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (level < 2 && level > 0 abilty < 8 && abilty > 6) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (level < 2 && level > 0 abilty < 9 && abilty > 7) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (level < 2 && level > 0 abilty < 10 && abilty > 8) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (level < 2 && level > 0 abilty < 11 && abilty > 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (level < 2 && level > 0 abilty < 12 && abilty > 10) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (level < 2 && level > 0 abilty < 13 && abilty > 11) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (level < 2 && level > 0 abilty < 14 && abilty > 12) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (level < 2 && level > 0 abilty < 15 && abilty > 13) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (level < 2 && level > 0 abilty < 16 && abilty > 14) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (level < 2 && level > 0 abilty < 17 && abilty > 15) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (level < 2 && level > 0 abilty < 18 && abilty > 16) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (level < 2 && level > 0 abilty < 19 && abilty > 17) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (level < 2 && level > 0 abilty < 20 && abilty > 18) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (level < 2 && level > 0 abilty < 21 && abilty > 19) ReStr = ReStr + Sheld ;
	if (level < 2 && level > 0 abilty < 22 && abilty > 20) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (level < 2 && level > 0 abilty < 23 && abilty > 21) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (level < 2 && level > 0 abilty < 24 && abilty > 22) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (level < 2 && level > 0 abilty < 25 && abilty > 23) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (level < 2 && level > 0 abilty < 26 && abilty > 24) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (level < 2 && level > 0 abilty < 27 && abilty > 25) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (level < 2 && level > 0 abilty < 28 && abilty > 26) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (level < 2 && level > 0 abilty < 29 && abilty > 27) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (level < 2 && level > 0 abilty < 30 && abilty > 28) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (level < 2 && level > 0 abilty < 31 && abilty > 29) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (level < 2 && level > 0 abilty < 32 && abilty > 30) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (level < 2 && level > 0 abilty < 33 && abilty > 31) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (level < 2 && level > 0 abilty < 34 && abilty > 32) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (level < 2 && level > 0 abilty < 35 && abilty > 33) ReStr = ReStr + BasicEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (level < 2 && level > 0 abilty < 36 && abilty > 34) ReStr = ReStr + BasicEffect ;
	if (level < 2 && level > 0 abilty < 37 && abilty > 35) ReStr = ReStr + '【入場曲】' + EnterEffect ;
	if (level < 2 && level > 0 abilty < 38 && abilty > 36) ReStr = ReStr + '【謝幕曲】' + DeathEffect ;
	if (level < 2 && level > 0 abilty < 39 && abilty > 37) ReStr = ReStr + '回合結束時' + EndEffect ;
	if (level < 2 && level > 0 abilty < 40 && abilty > 38) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (level < 2 && level > 0 abilty < 41 && abilty > 39) ReStr = ReStr + '【謝幕曲】【死靈術' + Shadow + '】' ;
	if (level < 2 && level > 0 abilty < 42 && abilty > 40) ReStr = ReStr + '【攻擊時】' + AttactEffect ;
	if (level < 2 && level > 0 abilty < 43 && abilty > 41) ReStr = ReStr + '【交戰時】' + InteractionEffect ;
	if (level < 2 && level > 0 abilty < 44 && abilty > 42) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect ;
	if (level < 2 && level > 0 abilty < 45 && abilty > 43) ReStr = ReStr + BasicEffect + '\n' + '【進化時】' + EvolutionEffect ;
	if (level < 2 && level > 0 abilty < 46 && abilty > 44) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【進化時】' + EvolutionEffect ;
	if (level < 2 && level > 0 abilty < 47 && abilty > 45) ReStr = ReStr + '【進化時】' + EvolutionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (level < 2 && level > 0 abilty < 48 && abilty > 46) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【進化時】' + EvolutionEffect ;
	if (level < 2 && level > 0 abilty < 49 && abilty > 47) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【進化時】' + EvolutionEffect ;
	if (level < 2 && level > 0 abilty < 50 && abilty > 48) ReStr = ReStr + '【進化時】' + EvolutionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (level < 2 && level > 0 abilty < 51 && abilty > 49) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【進化時】' + EvolutionEffect ;
	if (level < 2 && level > 0 abilty < 52 && abilty > 50) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【進化時】' + EvolutionEffect ;
	if (level < 2 && level > 0 abilty < 53 && abilty > 51) ReStr = ReStr + '【激奏' + RTOne + '】' + RushEffect + '\n' + '【進化時】' + EvolutionEffect ;
	if (level < 2 && level > 0 abilty < 54 && abilty > 52) ReStr = ReStr + '【進化時】' + EvolutionEffect ;
