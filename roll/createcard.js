...
function build7char(text01){
	...
	let RushEffectArr = ['給予自己的主戰者「下一次抽卡包時，可獲得在該卡包內的隨機一個造型。」效果。主戰者無法疊加此效果', '隨機給予敵方的一名從者1點傷害','隨機給予敵方的一名從者2點傷害','隨機破壞敵方一名從者','抽取1張牌','抽取3張牌','發動1回法術增幅','PP上限＋1','回復場上所有從者1滴血','回復場上所有從者2滴血','回復自己主戰1滴血','回復自己主戰2滴血','回復自己主戰3滴血','回復自己主戰4滴血','召喚1體殭屍(222白板)到自己場上','召喚1體骷髏(111白板)到自己場上','召喚1個援護砲擊到自己場上','召喚1個斯巴達的遺址到自己場上','召喚1個甦醒的熾天使到自己場上','召喚1個封印的熾天使到自己場上','PP上限＋2','對敵方全體從者做成1點傷害','對敵方全體從者做成2點傷害','召喚1個天狐神社到自己場上','給予1張封印的熾天使到手中','召喚1個鳳凰庭園到自己場上','給予1張斯巴達的遺址到手中','對敵方一名從者做成1點傷害','對敵方一名從者做成2點傷害','對敵方一名從者做成3點傷害','對敵方一名從者做成1點傷害4點傷害','破壞敵方1體從者','破壞敵方2體從者','破壞對方1體最高攻擊力的從者','破壞對方所有你選擇的同名從者','消滅敵方1體從者','消滅敵方2體從者','消滅對方1體最高攻擊力的從者','消滅對方所有你選擇的同名從者','隨機消滅敵方一名從者','直接勝利','消滅對方主戰','將對面所有語音轉變成老鼠吱吱聲','召喚1個不滅聖劍·杜蘭朵到自己場上','這場對戰中，給予自己的主戰者「自己的回合開始時，如果上個敵方的回合中，自己的主戰者受到的單次傷害大於4，則增加哥布林到敵方的手牌中直到上限。」效果','給予自己的主戰者「接下來的4場對戰獲得先攻，若敵方的主戰者也持有同效果，則失去此效果並對敵方的裝置使用DDoS。」效果。主戰者無法疊加此效果','給予自己的主戰者印牌的能力，主戰者無法疊加此效果','給予敵方的一名從者-1/-0效果','給予自己的一名從者+0/+1效果','增加一張哥布林到自己的手牌中','給予自己的一名從者+0/+2與突進效果','使一名敵方從者失去所有能力','給予自己的一名從者必殺效果','如果敵方的戰場上有守護效果的從者，則會隨機破壞一名敵方的從者','給予自己的一名從者+2/+2與守護效果','給予與這個從者交戰的敵方從者1點傷害','給予與這個從者交戰的敵方從者-1/-0效果','到回合結束為止，根據自己的手牌數獲得+1/+0效果','當自己的其他從者獲得+效果時，給予這個從者守護、必殺、潛行其中一個效果','當敵方的手牌數量大於7時，則會給予敵方的主戰者2點傷害','若自己的戰場上的從者數為5，且都獲得了+效果，則隨機消滅2個敵方的從者或護符']
	...
	let EnterEffectArr = ['給予自己的主戰者「下一次抽卡包時，可獲得在該卡包內的隨機一個造型。」效果。主戰者無法疊加此效果', '隨機給予敵方的一名從者1點傷害','隨機給予敵方的一名從者2點傷害','隨機破壞敵方一名從者','抽取1張牌','抽取3張牌','發動1回法術增幅','PP上限＋1','回復場上所有從者1滴血','回復場上所有從者2滴血','回復自己主戰1滴血','回復自己主戰2滴血','回復自己主戰3滴血','回復自己主戰4滴血','召喚1體殭屍(222白板)到自己場上','召喚1體骷髏(111白板)到自己場上','召喚1個援護砲擊到自己場上','召喚1個斯巴達的遺址到自己場上','召喚1個甦醒的熾天使到自己場上','召喚1個封印的熾天使到自己場上','PP上限＋2','對敵方全體從者做成1點傷害','對敵方全體從者做成2點傷害','召喚1個天狐神社到自己場上','給予1張封印的熾天使到手中','召喚1個鳳凰庭園到自己場上','給予1張斯巴達的遺址到手中','對敵方一名從者做成1點傷害','對敵方一名從者做成2點傷害','對敵方一名從者做成3點傷害','對敵方一名從者做成1點傷害4點傷害','破壞敵方1體從者','破壞敵方2體從者','破壞對方1體最高攻擊力的從者','破壞對方所有你選擇的同名從者','消滅敵方1體從者','消滅敵方2體從者','消滅對方1體最高攻擊力的從者','消滅對方所有你選擇的同名從者','隨機消滅敵方一名從者','直接勝利','消滅對方主戰','將對面所有語音轉變成老鼠吱吱聲','召喚1個不滅聖劍·杜蘭朵到自己場上','這場對戰中，給予自己的主戰者「自己的回合開始時，如果上個敵方的回合中，自己的主戰者受到的單次傷害大於4，則增加哥布林到敵方的手牌中直到上限。」效果','給予自己的主戰者「接下來的4場對戰獲得先攻，若敵方的主戰者也持有同效果，則失去此效果並對敵方的裝置使用DDoS。」效果。主戰者無法疊加此效果','給予自己的主戰者印牌的能力，主戰者無法疊加此效果','給予敵方的一名從者-1/-0效果','給予自己的一名從者+0/+1效果','增加一張哥布林到自己的手牌中','給予自己的一名從者+0/+2與突進效果','使一名敵方從者失去所有能力','給予自己的一名從者必殺效果','如果敵方的戰場上有守護效果的從者，則會隨機破壞一名敵方的從者','給予自己的一名從者+2/+2與守護效果','給予與這個從者交戰的敵方從者1點傷害','給予與這個從者交戰的敵方從者-1/-0效果','到回合結束為止，根據自己的手牌數獲得+1/+0效果','當自己的其他從者獲得+效果時，給予這個從者守護、必殺、潛行其中一個效果','當敵方的手牌數量大於7時，則會給予敵方的主戰者2點傷害','若自己的戰場上的從者數為5，且都獲得了+效果，則隨機消滅2個敵方的從者或護符']
	let EnterEffect = EnterEffectArr[Math.floor((Math.random() * (EnterEffectArr.length)) + 0)];
	let EnterShadowArr = ['給予自己的主戰者「下一次抽卡包時，可獲得在該卡包內的隨機一個造型。」效果。主戰者無法疊加此效果', '隨機給予敵方的一名從者1點傷害','隨機給予敵方的一名從者2點傷害','隨機破壞敵方一名從者','抽取1張牌','抽取3張牌','發動1回法術增幅','PP上限＋1','回復場上所有從者1滴血','回復場上所有從者2滴血','回復自己主戰1滴血','回復自己主戰2滴血','回復自己主戰3滴血','回復自己主戰4滴血','召喚1體殭屍(222白板)到自己場上','召喚1體骷髏(111白板)到自己場上','召喚1個援護砲擊到自己場上','召喚1個斯巴達的遺址到自己場上','召喚1個甦醒的熾天使到自己場上','召喚1個封印的熾天使到自己場上','PP上限＋2','對敵方全體從者做成1點傷害','對敵方全體從者做成2點傷害','召喚1個天狐神社到自己場上','給予1張封印的熾天使到手中','召喚1個鳳凰庭園到自己場上','給予1張斯巴達的遺址到手中','對敵方一名從者做成1點傷害','對敵方一名從者做成2點傷害','對敵方一名從者做成3點傷害','對敵方一名從者做成1點傷害4點傷害','破壞敵方1體從者','破壞敵方2體從者','破壞對方1體最高攻擊力的從者','破壞對方所有你選擇的同名從者','消滅敵方1體從者','消滅敵方2體從者','消滅對方1體最高攻擊力的從者','消滅對方所有你選擇的同名從者','隨機消滅敵方一名從者','直接勝利','消滅對方主戰','將對面所有語音轉變成老鼠吱吱聲','召喚1個不滅聖劍·杜蘭朵到自己場上','這場對戰中，給予自己的主戰者「自己的回合開始時，如果上個敵方的回合中，自己的主戰者受到的單次傷害大於4，則增加哥布林到敵方的手牌中直到上限。」效果','給予自己的主戰者「接下來的4場對戰獲得先攻，若敵方的主戰者也持有同效果，則失去此效果並對敵方的裝置使用DDoS。」效果。主戰者無法疊加此效果','給予自己的主戰者印牌的能力，主戰者無法疊加此效果','給予敵方的一名從者-1/-0效果','給予自己的一名從者+0/+1效果','增加一張哥布林到自己的手牌中','給予自己的一名從者+0/+2與突進效果','使一名敵方從者失去所有能力','給予自己的一名從者必殺效果','如果敵方的戰場上有守護效果的從者，則會隨機破壞一名敵方的從者','給予自己的一名從者+2/+2與守護效果','給予與這個從者交戰的敵方從者1點傷害','給予與這個從者交戰的敵方從者-1/-0效果','到回合結束為止，根據自己的手牌數獲得+1/+0效果','當自己的其他從者獲得+效果時，給予這個從者守護、必殺、潛行其中一個效果','當敵方的手牌數量大於7時，則會給予敵方的主戰者2點傷害','若自己的戰場上的從者數為5，且都獲得了+效果，則隨機消滅2個敵方的從者或護符','獲得1回可以攻擊2次的效果','獲得1回可以攻擊3次的效果']
