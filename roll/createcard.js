...
function build7char(text01){
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTTwo + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTTwo + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTTwo + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTTwo + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTTwo + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTTwo + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTTwo + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTThree + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTThree + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTThree + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTThree + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTThree + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTThree + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTThree + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTFour + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTFour + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTFour + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTFour + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTFour + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTFour + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTFour + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTFive + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTFive + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTFive + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTFive + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTFive + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTFive + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTFive + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTSix + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTSix + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTSix + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTSix + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTSix + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTSix + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTSix + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTSeven + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTSeven + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTSeven + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTSeven + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTSeven + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTSeven + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTSeven + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTEight + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTEight + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTEight + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTEight + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTEight + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTEight + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTEight + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTNine + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTNine + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTNine + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTNine + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTNine + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTNine + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTNine + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
	...
	if (abilty = 6) ReStr = ReStr + BasicEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 7) ReStr = ReStr + '【入場曲】' + '\n' + EnterEffect + '【謝幕曲】' + DeathEffect ;
	if (abilty = 8) ReStr = ReStr + '【激奏' + RTTen + '】' + RushEffect + '\n' + '【入場曲】' + EnterEffect ;
	if (abilty = 9) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 10) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ; ;
	if (abilty = 11) ReStr = ReStr + '【激奏' + RTTen + '】' + RushEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 12) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】' + DeathEffect ;	
	if (abilty = 13) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 14) ReStr = ReStr + '【激奏' + RTTen + '】' + RushEffect + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 15) ReStr = ReStr + '【激奏' + RTTen + '】' + RushEffect + '\n' + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow ;
	if (abilty = 16) ReStr = ReStr + '【激奏' + RTTen + '】' + RushEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 17) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '回合結束時' + EndEffect ;
	if (abilty = 18) ReStr = ReStr + '回合結束時' + EndEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow;
	if (abilty = 19) ReStr = ReStr + '入場死靈 謝幕死靈' + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 20) ReStr = ReStr + Sheld ;
	if (abilty = 21) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【交戰時】' + InteractionEffect ;	
	if (abilty = 22) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 23) ReStr = ReStr + '【激奏' + RTTen + '】' + RushEffect + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 24) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '回合結束時' + EndEffect  ;
	if (abilty = 25) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【交戰時】' + InteractionEffect ;
	if (abilty = 26) ReStr = ReStr + '【交戰時】' + InteractionEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow  ;
	if (abilty = 27) ReStr = ReStr + '【入場曲】' + EnterEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 28) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】' + DeathEffect ;
	if (abilty = 29) ReStr = ReStr + '【激奏' + RTTen + '】' + RushEffect + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 30) ReStr = ReStr + + '【攻擊時】' + AttactEffect + '回合結束時' + EndEffect ;
	if (abilty = 31) ReStr = ReStr + '【入場曲】【死靈術' + Shadow + '】' + EnterShadow + '\n' + '【攻擊時】' + AttactEffect ;
	if (abilty = 32) ReStr = ReStr + '【攻擊時】' + AttactEffect + '\n' + '【謝幕曲】【死靈術' + Shadow + '】' + DeathShadow ;
	if (abilty = 33) ReStr = ReStr + BasicEffect + '\n' + '【攻擊時】' + AttactEffect ;
