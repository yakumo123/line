...
if (count == 11) returnStr = '黑龍騎士‧法露特-虹';
if (count == 12) returnStr = '吉爾尼特拉-虹';
if (count == 13) returnStr = '法夫納-虹';
if (count == 14) returnStr = '水龍神巫女-虹';
if (count == 15) returnStr = '烏洛波羅斯-虹';
if (count == 16) returnStr = '帝國龍騎士-虹';
if (count == 17) returnStr = '喚龍魔笛-虹';
